...
class DisplayNameTokenObtainPairSerializer(TokenObtainPairSerializer):
    @classmethod
...
class DisplayNameTokenObtainPairView(TokenObtainPairView):
    serializer_class = DisplayNameTokenObtainPairSerializer
